...
def endGame():
    ...
    textBoxSpace = 5
    textBoxNumber = 0
    message = "Tempo: " + str(round(timeTaken)) + "s"
    while True:
        ...
        button("Sim",(width/2)-50,420,100,50,darklightred,lightred,quitGame)
        button("Não",(width/2)-50,500,100,50,darklightred,lightred,hangman)
        
        largeText = pygame.font.SysFont("comicsansms",115)
        TextSurf = largeText.render("Fechar o jogo?",True,darklightred)
...
def pause():
    ...
    while pause:
        ...
        button("Continuar",150,450,100,50,darklightred,lightred,unpause)
        button("Fechar",550,450,100,50,darklightblue,lightblue,quitgame)
...
def hangman():
    ...
    while play == True:
        ...
        textSurf = text.render("Escolha uma categoria",True,black)
        textRect = textSurf.get_rect()
        textRect.center = ((width/2),(height/2))
        screen.blit(textSurf, textRect)

        button("Educação",300,400,150,100,black,lightgrey,Educacao)
...
def hangmanGame(catagory,title):
    ...
    while gamePlay == True:
        ...
        button("Voltar",50,50,100,50,black,lightgrey,hangman)
